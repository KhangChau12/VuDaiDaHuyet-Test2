...
export const handleFrustration = (player, removePlayerFn, changeTeamFn) => {
  if (player.frustration >= 2) {
    if (player.role === 'Chí Phèo' && player.team !== 'Công Lý') {
      // Chí Phèo chuyển sang phe Công Lý khi có 2 điểm uất ức và chưa thuộc phe Công Lý
    ...
    } else if (player.role === 'Chí Phèo' && player.team === 'Công Lý') {
